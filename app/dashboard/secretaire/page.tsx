    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 py-6 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Secrétaire Dashboard</h1>
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 flex gap-8">
          {["files", "users", "permissions"].map((tab) => (
            <button
              key={tab}
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {activeTab === "permissions" && (
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-xl font-bold mb-4">Gestion des Permissions</h2>
            <div className="space-y-4">{/* Permissions will be loaded here */}</div>
          </div>
        )}
      </main>
    </div>
